...
> - SKILL:`~/.claude/skills/lingshu-spec-driven-dev/SKILL.md` v1.0.21 / 192 行 / 自动触发(R-13 dep-tree 自查链路已纳入 + 同步 dsh v1.5.32 → v1.5.33 — §5.6.3.0 新增四个核心类型完整定义(`AgentCard` + `AgentRef` + `RemoteAgentSchemaBuilder` + `AgentCardCache`);v1.5.32 §6.4 Skill 三个契约锚点补全不变)
