...
**Version**: 1.3.8(+dsh §5.1 L1463 orphan fence opener 误吞修复 — 严格 CommonMark 状态机审计发现 + 用户截图反馈;CLAUDE.md §4 配套描述更新;配套同步 dsh v1.5.16;SKILL v1.0.8 / SOP v1.3 / prompts v1.0.2 不变)
**对应设计文档**: `dsh_agent_design.md` v1.5.16
