...
**Version**: 1.3.11(+dsh §6.1 LinearTurnEngine + Provider 加类级 Javadoc 澄清「6/8 Router」是有意设计;CLAUDE.md §4 配套描述更新;配套同步 dsh v1.5.19;SKILL v1.0.8 / SOP v1.3 / prompts v1.0.2 不变)
**对应设计文档**: `dsh_agent_design.md` v1.5.19
