...
> - SKILL:`~/.claude/skills/lingshu-spec-driven-dev/SKILL.md` v1.0.20 / 192 行 / 自动触发(R-13 dep-tree 自查链路已纳入 + 同步 dsh v1.5.31 §5.6.3 L2429-2444 RemoteAgentTool 降级为普通 Tool 模式)
